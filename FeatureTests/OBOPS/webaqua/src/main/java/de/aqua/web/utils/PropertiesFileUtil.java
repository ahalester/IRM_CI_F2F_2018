...
public class PropertiesFileUtil {
    ...
    public static void writePropertiesFile(String fileName, String propName, String propValue) {
        try {
            ...
            File file = new File("src/test/resources/properties/" + fileName + ".properties");
    ...
    public static String getProperty(String fileName, String propName) {
        ...
        try (FileReader reader = new FileReader("src/test/resources/properties/" + fileName + ".properties")) {
            Properties properties = new Properties();
     ...
     * @return string containing the specific url for the
     * requested property name
     */
    public static String getNavigationURL(String fileName, String url) {
        String propertyValue = "";
        try (FileReader reader = new FileReader("src/test/resources/properties/" + fileName + ".url")) {
            Properties properties = new Properties();
            properties.load(reader);
