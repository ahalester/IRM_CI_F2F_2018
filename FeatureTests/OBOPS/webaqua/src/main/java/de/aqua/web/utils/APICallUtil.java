...
public class APICallUtil {
    ...
    public static ClientResponse callRequest(String url, List<String> httpHeader,
                                             List<String> proxy, String callType, String body, Map<String, String> callResponse) {
...
//            webResource = null;
     ...
     * @param authString  string which will be passed as a parameter to the web resource for HTTP header
     *                    login
        ...
        switch (authType) {
            case "basic": {
                response = webResource.accept(MediaType.APPLICATION_JSON)
                        .type(MediaType.APPLICATION_JSON).header(AUTHORIZATION, AUTH_TYPE + authString)
    ...
    /**
     * Returns the absolute URL without unencoded chars
     *
