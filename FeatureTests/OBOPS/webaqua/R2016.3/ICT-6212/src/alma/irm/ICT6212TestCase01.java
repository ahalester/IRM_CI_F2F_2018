...
public class ICT6212TestCase01 {
  ...
  @Test
  public void testICT6212TestCase01() throws Exception {
    driver.get(baseUrl + "/webaqua/");
    driver.findElement(By.id("zk_c_76-cave")).click();
    driver.findElement(By.id("zk_c_104")).clear();
    driver.findElement(By.id("zk_c_104")).sendKeys("uid://A002/Xb204f6/X14f6");
    ...
    driver.findElement(By.id("_z_0-y6")).click();
    ...
    driver.findElement(By.id("_z_2-ty")).click();
    driver.findElement(By.id("_z_2-y6")).click();
    driver.findElement(By.id("_z_2-m11")).click();
    driver.findElement(By.xpath("//tr[@id='_z_2-w4']/td[5]")).click();
    driver.findElement(By.id("zk_c_2009")).click();
    driver.findElement(By.id("zk_c_1994-cnt")).click();
    assertTrue(isElementPresent(By.id("atmospherePlotDivblank_2000-380")));
  }
