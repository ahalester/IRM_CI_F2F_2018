...
public class ICT5258TestCase01 {
  ...
  @Test
  public void testICT5258TestCase01() throws Exception {
    driver.get(baseUrl + "/webaqua/");
    driver.findElement(By.id("zk_c_76-cave")).click();
    driver.findElement(By.id("zk_c_104")).clear();
    driver.findElement(By.id("zk_c_104")).sendKeys("uid://A002/X9aca45/X190e");
    ...
    driver.findElement(By.id("zk_c_451")).click();
    driver.findElement(By.id("zk_c_444-cnt")).click();
    assertTrue(isElementPresent(By.id("distributionPlotDiv-chdex")));
  }
