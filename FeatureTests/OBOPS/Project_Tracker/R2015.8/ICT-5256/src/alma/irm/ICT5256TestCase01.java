...
public class ICT5256TestCase01 {
  ...
  @Test
  public void testICT5256TestCase01() throws Exception {
    ...
    driver.findElement(By.xpath("(//input[@name='file'])[2]")).sendKeys("/home/patricio/workspace_trunk/IRM/SeleniumGridTest/Project_Tracker/R2015.8/ICT-5256/csv/MOUS_state_changes_testcase01.csv");
    try {
