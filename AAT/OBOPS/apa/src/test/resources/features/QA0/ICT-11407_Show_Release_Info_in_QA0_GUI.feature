...
Feature: Show release info in QA0 GUI - https://ictjira.alma.cl/browse/ICT-11407
...
#    Given QA0 test environment is available
  ...
  @all @sanity @regression-phab
  Scenario: AQUA release info available in the QA0 GUI
