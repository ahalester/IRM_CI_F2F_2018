...
import cl.apa.web.utils.enums.EnvironmentURL;
...
public class PropertiesFileUtil {
    ...
    public static String getProperty(String propName) {
        return getProperty("APA", propName);
    }
    ...
    public static String getApaLocator(String locatorName) {
        return getProperty("apaLocators", locatorName);
    }
    ...
    public static String getAPAProperty(String propName) { return getProperty("APA", propName); }
