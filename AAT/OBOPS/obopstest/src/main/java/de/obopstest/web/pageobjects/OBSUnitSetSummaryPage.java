...
//                .findElements(By.className("z-comboitem-text"));
    ...
    public static WebElement getOusStatusLabel(WebDriverExtended driver) {
        String xpath = "//span[@class=\"z-label\"][(text()=\"State\")]/../../following-sibling::td[1]//span[@class=\"z-label\"]";
