...
import static de.obopstest.web.utils.CaptureScreenshotUtil.captureScreenshot;
...
import static de.obopstest.web.utils.WaitUtil.DEFAULT_WAIT_FOR_ELEMENT;
import static de.obopstest.web.utils.WaitUtil.DEFAULT_WAIT_FOR_PAGE_LOAD;
...
//            }
    ...
    private WebDriver firefoxSetup(String grid, String docker, String selenium) throws MalformedURLException {
        ...
        // Not yet implemented for Firefox webdriver.gecko.driver
//        LoggingPreferences logs = new LoggingPreferences();
//        logs.enable(LogType.BROWSER, Level.ALL);
//        fdc.setCapability(CapabilityType.LOGGING_PREFS, logs);
    ...
    private WebDriver chromeSetup(String grid, String docker, String selenium) throws MalformedURLException {
        ...
        cdc.setCapability(CapabilityType.LOGGING_PREFS, logPrefs);
