...
import static de.obopstest.web.utils.ReadWriteTextToFileUtil.readFile;
...
public class StringUtil {
    ...
    public static String removeBreakingWhitespace(String text) {
        return text.replaceAll("\r", "").replaceAll("\n", "").replaceAll(" ", "");
    }

    public static String removeBreakingWhitespaceIgnoring(String text, String ignoring) {
        return text.replaceAll("\r", "").replaceAll("\n", "").replaceAll(ignoring, "").replaceAll("\\s+", " ");
    }

    public static boolean compareStringsIgnoring(String actual, String expected, String ignoring) {
        String a = actual.trim().replaceAll("\r", "").replaceAll("\n", "").replaceAll(ignoring, "").replaceAll("\\s+", " ");
        String b = expected.trim().replaceAll("\r", "").replaceAll("\n", "").replaceAll(ignoring, "").replaceAll("\\s+", " ");
