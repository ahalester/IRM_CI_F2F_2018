...
public class StringUtil {
    ...
    public static String absoluteSshCmd(String sshCmd, String relativeCmd) {
        String absoluteCmd = "";
        try {
            if (FileUtil.readFile(relativeCmd).contains("http")) {
                absoluteCmd = sshCmd + removeHttpAndPort(FileUtil.readFile(relativeCmd));
            } else {
                absoluteCmd = sshCmd + FileUtil.readFile(relativeCmd);
            }
    ...
    public static String removeGenericsFromSshCmd(String sshCmd, String gatewayMachine,
        ...
        try {
            innerMachine = removeHttpAndPort(FileUtil.readFile(innerMachine));
            sshCmd = sshCmd.replace("<gateway_machine>", FileUtil.readFile(gatewayMachine));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static String fillSystemRegisterCmdWithParams(String sshCmd, String endpointIp,
        ...
        try {
            sshCmd = sshCmd.replace("<provide_SC_server_ip>", FileUtil.readFile(serverIp));
        } catch (IOException e) {
            e.printStackTrace();
        }
        try {
            sshCmd = sshCmd.replace("<provide_SC_api_key>", FileUtil.readFile(apiKey));
        } catch (IOException e) {
            e.printStackTrace();
        }
        return sshCmd;
    ...
    public static String fillFileDownloadCmdWithParams(String sshCmd, String fileName,
        ...
        try {
            sshCmd = sshCmd.replace("<generated_system_id>", FileUtil.readFile(systemId));
        } catch (IOException e) {
            e.printStackTrace();
        }
        try {
    ...
    public static String getLastTestResult(String fileName) {
        ...
        try {
            fileContent = FileUtil.readFile(fileName);
        } catch (IOException e) {
