...
public class WebElementValidationUtil {
    ...
    public static void elementDisplayedValidation(WebDriverExtended driver, WebElement we,
        ...
        try {
            ...
            LOG.error(String.format("The web element '%s' couldn't be found on the page!", elementName));
            Assert.fail(String.format("The web element '%s' couldn't be found on the page!", elementName));
        }
    }
