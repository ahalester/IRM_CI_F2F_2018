...
public class AdvancedSearchByPositionAndOptions extends TestBase {
	
	@Test
	public void Search_FilterByPositionAndOptions_ReturnsSameResultsAsInDB() throws Exception {
		// Arrange
	...
	@Test
	public void Search_FilterByAllCriteriaInPositionAndOptions_ReturnsNOResults() {
		// Arrange
		queryFormUtil.insertValue(PositionComponentIDs.sourceNameId,
