...
public class SimpleSearchByTime extends TestBase {

	@Test
	public void Search_FilterByTimeAfterBefore_ReturnsSameNumberOfResultsAsInDB()
			throws Exception {
		// Arrange "
	...
	@Test
	public void Search_FilterByTimeAfter_ReturnsSameNumberOfResultsAsInDB()
			throws Exception {
		// Arrange
		String query = "SELECT count(measurement_id) FROM "
				+ " (SELECT q.*, row_number() over (partition by source_id, bandName order by date_observed desc, measurement_id desc) source_band_rownum"
	...
	@Test
	public void Search_FilterByTimeBefore_ReturnsSameNumberOfResultsAsInDB()
			throws Exception {
		// Arrange
		String query = "SELECT count(measurement_id) FROM "
				+ " (SELECT q.*, row_number() over (partition by source_id, bandName order by date_observed desc, measurement_id desc) source_band_rownum"
	...
	@Test
	public void Search_FilterByTimeAfterBefore_ReturnsNOResults() {
		// Arrange
		queryFormUtil.insertValue(TimeComponentIDs.timeAfterId,
