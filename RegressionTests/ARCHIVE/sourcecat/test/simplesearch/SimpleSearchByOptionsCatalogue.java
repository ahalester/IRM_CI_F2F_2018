...
public class SimpleSearchByOptionsCatalogue extends TestBase {

	@Test
	public void Search_FilterByCatalogue_ReturnsSameNumberOfRowsAsInDB()
			throws Exception {
	...
	@Test
	public void Search_FilterByCatalogue_ReturnsNOResults() {
		queryFormUtil.selectOptionInMultiSelectDropDown(
				OptionsComponentIDs.cataloguesId,
