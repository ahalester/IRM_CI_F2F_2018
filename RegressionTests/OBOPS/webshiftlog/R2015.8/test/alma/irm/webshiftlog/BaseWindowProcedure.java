...
class BaseWindowProcedure{
	...
	void backToPreviousPage(CommonTools cmt,String title){
		...
		log(myInfo + "...Just sleep for 500./1000.s...");
		cmt.sleep(500);			// Need this sleep for finishing the test successfully!!!
	}
	 ...
	 * @param int n
	 */
	void sortList(CommonTools cmt,String cnameP,String cnameC, int n){
		String myInfo = thisClass.concat("#").concat(new Throwable().getStackTrace()[0].getMethodName()).concat(": ");
