 ...
 * 
 * PURPOSE: 
 *  Description of methods which are implemented in CommonTools class. 
 *  
 * PRE- AND POST-CONDITIONS:
 *  
 * MAINTENANCE:
 *  - Not all methods in CommonTools are described at the moment.
 *   If need, put also the other methods.
 *  
 * ----------------------------------------------------------------
 * AMENDEMENTS
 * <date>		<name>	<what & why>
