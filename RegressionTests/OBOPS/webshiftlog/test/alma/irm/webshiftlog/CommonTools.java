/*
 * NAME: CommonTools.java
 * AUTHOR: Kyoko Nakamura
 * DATE: 2015-09-14
 * 
 * PURPOSE: 
 *  A set of common methods which include the operation of WebDriver.
 *  
 ...
 * 2017-07-13	knaka	Created waitUntilNewClassShown() which wait new class appears
 * 2018-04-27	knaka	Changed argument of sleep() to defined variable 
 * ----------------------------------------------------------------
 */
...
//			outTs = tmpStr[0 + 2*k];				
	...
	/*
	 * @brief Wait for a new class (caret after sorting finished) is appeared
	 * @param By locator
	 * @param int timeOutInSeconds
	 */
	public void waitUntilNewClassShown(final By locator, int timeOutInSeconds) throws Exception{
...
//		return (chkMsg == null || chkMsg.equals(noMsg) || chkMsg == "");
	...
	String showTooltip(By locatorP,By locatorC,int nP,int nC){
		...
		sleep(ONESEC);							// 1 second seems good
